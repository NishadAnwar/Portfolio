...
const NavContainer = styled.div`
    ...
    background : ${({ theme }) => theme.card_light + 'dd'};
`;
    ...
    return (
        <Nav>
            <NavContainer className={isScroll ? "scrolled" : ""}>
                ...
                <ButtonContainer>
                    <Button href="https://github.com/NishadAnwar" target="blank">Github</Button>
                    <Button href="https://www.linkedin.com/in/md-nishad-anwar-7b4076224/" target="blank">LinkedIn</Button>
                </ButtonContainer>
                    ...
                    isOpen && 
                            <MobileMenu isOpen={isOpen}>
                                ...
                                <MobileButtonContainer isOpen={isOpen}>
                                    <MobileButton href="https://github.com/NishadAnwar" target="blank">Github</MobileButton>
                                    <MobileButton href="https://www.linkedin.com/in/md-nishad-anwar-7b4076224/" target="blank">LinkedIn</MobileButton>
